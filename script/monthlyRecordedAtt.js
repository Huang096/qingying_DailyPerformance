...
function onFormSubmit(e) {
  ...
  //用来测试不同月份是否能成功建表, 测试通过，实际开发过程要改回
  var today = new Date;
...
function updateMonthlySheet(monthlySheetName, name, attendance) {
  ...
  if (monthlyRowIndex == -1) {
    // 如果没有找到对应的行，则添加一行
    monthlySheet.appendRow([name, attendance == 1 ? '全勤' : '有缺勤记录']);
  } else {
...
function testOnFormSubmit() {
  ...
  // 添加测试数据
  var testData = [
    ['2024-06-15 08:30:00', '张三', '签到'],
    ['2024-06-15 17:30:00', '张三', '签退'],
    ['2024-06-15 09:30:00', '李四', '签到'],
    ['2024-06-15 17:30:00', '李四', '签退'],
    ['2024-06-15 08:30:00', '王五', '签到'],
    ['2024-06-15 13:30:00', '王五', '签退'],
    ['2024-06-15 09:30:00', '赵六', '签到'],
    ['2024-06-15 18:30:00', '赵六', '签退'],
  ];
